...
describe('getFirstMatchingPattern', function () { 
  it('should return a matching pattern when the first matches', function () {
    var patterns = ["https:\\/\\/example\\.com"];

    assert.equal(patterns[0], configUtil.getFirstMatchingPattern(patterns, "https://example.com"));
  });

  it('should return the first matching pattern when more than one matches', function () {
  ...
  it('should return undefined when it does not match', function () {
    var patterns = ["https:\\/\\/example\\.com"];

    assert.isUndefined(configUtil.getFirstMatchingPattern(patterns, "https://github.com"));
  });

  it('should return undefined when the patterns is empty', function () {
  ...
  it('should return the first matching ROOT_URL replacement', function () {
  ...
  it('should return undefined if the ROOT_URL replacement still does not match', function () {
    var patterns = [ "^#{ROOT_URL}\\/lala\\/$" ];
