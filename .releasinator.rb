configatron.product_name = "spidersuite"
...
def wait_for_package_manager(version)
  CommandProcessor.wait_for("wget -U \"non-empty-user-agent\" -qO- https://registry.npmjs.org/spidersuite | jq '.[\"dist-tags\"][\"latest\"]' | grep #{package_version()} | cat")
end
