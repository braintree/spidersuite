...
const LoggerFactory = require(path.resolve('./Logger'));
const ErrorHandlerFactory = require(path.resolve('./ErrorHandler'));
const HashProcessorFactory = require(path.resolve('./HashProcessor'));
const configUtil = require(path.resolve('./config/configUtil'))();
