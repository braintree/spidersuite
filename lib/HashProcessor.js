...
module.exports = function (crawler, errorHandler, logger) {
  // This is an object whose key is URL, and the value is an object that defines possible hash targets.
  const hashesFound = {};

  // This is an object whose key is URL, and the value is an object of hash targets that are expected.
  ...
  return {
     ...
     */
    findErrors() {
      _.forIn(hashesExpected, (idsExpected, url) => {
