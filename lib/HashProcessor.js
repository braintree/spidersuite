...
module.exports = function HashProcessor(crawler, errorHandler, logger) {
  // This is an object whose key is URL, and the value is an object that
  // defines possible hash targets.
  const hashesFound = {};

  // This is an object whose key is URL, and the value is an object of hash
  // targets that are expected.
  ...
  return {
    ...
    findSupportedHashes(url, $) {
      $('[id],a[name]').each(function setHashesFound() {
        const $elem = $(this);
